...
USERNAME = environ.get('USERNAME', "https://t.me/Acdsupportbot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002352877704'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002452333091')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://cruel-rubia-musicmechanic-44eef998.koyeb.app/")
